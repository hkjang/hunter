...
export default function App() {
  const [user, setUser] = useState<User | null>(null),
    ...
    [config, setConfig] = useState<Row>({ version: "1.15.0" });
    ...
    <div className="login-page">
      ...
      <section className="login-panel">
        ...
        <footer className="login-footer">
          ...
          <span>
            서비스 버전 <b>v{authConfig.version || "1.15.0"}</b>
          </span>
        </footer>
      </section>
    </div>
      ...
      >
        ...
        <div className="sidebar-bottom">
          <div className="sidebar-status">
            ...
            오프라인 운영 준비<span>v{config.version || "1.15.0"}</span>
          </div>
          <Menu width={255} position="top-start" shadow="md" offset={12}>
            ...
            <Menu.Dropdown>
              ...
              <Menu.Divider />
              <Menu.Label>
                hunter · 서비스 버전 v{config.version || "1.15.0"}
              </Menu.Label>
              <Menu.Item
                color="red"

const captions = {"admin-tracking":"방문 추적","sso-local-login":"SSO 복구","agent-platform-models":"모델 연결","agent-platform-execution":"격리 실행","agent-paused":"일시 중지 · 재개","agent-report":"실행 보고서",'automation-recipients':'자동화 관리','automation-workflows':'변경 영향 규칙','personal-inbox':'내 업무 알림',dashboard:'보안 현황', services:'서비스 자산', findings:'발견 건',triage:'조치함',software:'소프트웨어 구성','campaign-compare':'캠페인 비교','finding-bulk':'일괄 변경','campaign-copy':'캠페인 복사','notifications-channels':'알림 채널','notifications-history':'전달 이력','agent-detail':'에이전트 진단','admin-settings':'관리자 설정','personal-keys':'개인 API 키'};

...
v1.4의 소프트웨어 명세·위협 정보·캠페인 흐름에 v1.5.0의 반복 업무 편의를 더했습니다. 발견 건 일괄 변경, 현재 목록 CSV·주소 복사, 동시 편집 충돌 안내, 작성 중인 입력 보호, 탭별 조회 조건·저장 보기와 같은 대상으로 새 캠페인 만들기를 제공합니다. [조사와 채택 범위](docs/research-v140.md)는 네 공식 프로젝트의 문서·GitHub 이슈에 근거하며, 새 운영 기능은 Hunter 자체 코드입니다. 기존 PentAGI 원본 코어는 그대로 보존합니다.
...
| 항목 | 형식 | v1.5.0 예시 |
| --- | --- | --- |
| Docker 이미지 | hunter:v버전 | hunter:v1.5.0 |
| 유일한 첨부 자산 | hunter-v버전.tar.gz | hunter-v1.5.0.tar.gz |
